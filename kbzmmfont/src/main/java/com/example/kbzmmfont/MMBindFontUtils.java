...
public class MMBindFontUtils {
    ...
    * */
    public static void checkSupportMMFontType(Context context) {
        ...
        textView1.setTypeface(KbzMMFontCache.get(Fonts.MM3, context));
        textView2.setTypeface(KbzMMFontCache.get(Fonts.MM3, context));
        textView3.setTypeface(KbzMMFontCache.get(Fonts.MM3, context));
        textView4.setTypeface(KbzMMFontCache.get(Fonts.MM3, context));
